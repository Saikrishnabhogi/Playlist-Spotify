...
openai.api_key = "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"
...
def add_songs_to_spotify(playlist_prompt, playlist):
    ...
    sp = spotipy.Spotify(
        auth_manager=spotipy.SpotifyOAuth(
            client_id= "6410866ebb074e64936630ecd2e01668",
            client_secret= "658c7857024645b18c1a56fd541fb86e",
    ...
    webbrowser.open_new(created_playlist["external_urls"]["spotify"])
